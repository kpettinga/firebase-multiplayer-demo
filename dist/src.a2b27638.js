...
function queryParamsToRestQueryStringParameters(queryParams) {
  ...
  if (queryParams.startSet_) {
    ...
    if (queryParams.startNameSet_) {
      qs["startAt" /* START_AT */] += ',' + (0, _util.stringify)(queryParams.indexStartName_);
    }
  }
  if (queryParams.endSet_) {
    qs["endAt" /* END_AT */] = (0, _util.stringify)(queryParams.indexEndValue_);
    if (queryParams.endNameSet_) {
      qs["endAt" /* END_AT */] += ',' + (0, _util.stringify)(queryParams.indexEndName_);
    }
  }
...
var addPlayerNode = function addPlayerNode(data) {
  var _playerNode$classList;
  var x = data.x,
    y = data.y,
    id = data.id,
  ...
  playerNode.id = id;
  if (classNames instanceof Object) (_playerNode$classList = playerNode.classList).add.apply(_playerNode$classList, ["player"].concat(_toConsumableArray(classNames)));
  move(playerNode, x, y);
  return playerNode;
};
exports.addPlayerNode = addPlayerNode;
var addMovementControls = function addMovementControls(playerNode, onMove) {
...
exports.addMovementControls = addMovementControls;
var move = function move(playerNode, x, y) {
  playerNode.style.transform = "translate3d(".concat(x, "px,").concat(y, "px,0)");
};
exports.move = move;
...
var playersRef = (0, _database.ref)(database, "players");
var startingPosition = {
  x: 100,
  y: 100
};
var playerRef = (0, _database.push)(playersRef, startingPosition);
var playerNode = (0, _util.addPlayerNode)(_objectSpread(_objectSpread({}, startingPosition), {}, {
  id: playerRef.key,
  classNames: ["own"]
}));
appContainer.appendChild(playerNode);
(0, _util.addMovementControls)(playerNode, function (x, y) {
  (0, _database.set)(playerRef, {
    x: x,
    y: y
  });
});
(0, _database.onDisconnect)(playerRef).update({
  disconnecting: true
});
(0, _database.onValue)(playersRef, function (snapshot) {
  snapshot.forEach(function (player) {
    if (player.key === playerRef.key) {
      return;
    }
    var _player$val = player.val(),
      x = _player$val.x,
      y = _player$val.y,
      disconnecting = _player$val.disconnecting;
    var otherPlayerNode = document.getElementById(player.key);
    if (otherPlayerNode) {
      if (disconnecting) {
        appContainer.removeChild(document.getElementById(player.key));
        (0, _database.remove)(player.ref);
        return;
      }
      (0, _util.move)(otherPlayerNode, x, y);
    } else {
      otherPlayerNode = (0, _util.addPlayerNode)({
        x: 100,
        y: 100,
        id: player.key
      });
...
},{"@firebase/app":"node_modules/@firebase/app/dist/esm/index.esm2017.js","@firebase/database":"node_modules/@firebase/database/dist/index.esm2017.js","./util":"src/util.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
